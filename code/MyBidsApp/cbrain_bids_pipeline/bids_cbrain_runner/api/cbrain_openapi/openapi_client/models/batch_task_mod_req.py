...
class BatchTaskModReq(BaseModel):
    """
    BatchTaskModReq
    """ # noqa: E501
    tasklist: Optional[List[StrictInt]] = None
    batch_ids: Optional[List[StrictInt]] = None
    __properties: ClassVar[List[str]] = ["tasklist", "batch_ids"]
