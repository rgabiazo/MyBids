...
class UsersApi:
    ...
    def users_id_delete(
        self,
        id: Annotated[StrictInt, Field(description="ID of user to update")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def users_id_patch(
        self,
        id: Annotated[StrictInt, Field(description="ID of user to update")],
        user_mod_req: Annotated[UserModReq, Field(description="An object representing a request for a new User")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: ID of user to update (required)
        :type id: int
        :param user_mod_req: An object representing a request for a new User (required)
        :type user_mod_req: UserModReq
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _users_id_patch_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if user_mod_req is not None:
            _body_params = user_mod_req
