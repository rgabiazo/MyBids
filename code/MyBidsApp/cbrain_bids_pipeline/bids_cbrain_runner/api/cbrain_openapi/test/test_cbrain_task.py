...
class TestCbrainTask(unittest.TestCase):
    """CbrainTask unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CbrainTask:
        """Test CbrainTask
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CbrainTask`
        """
        model = CbrainTask()
        if include_optional:
            return CbrainTask(
